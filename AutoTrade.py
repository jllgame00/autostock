...
def get_target_price(code):
    ...
    try:
        ...
        target_price = today_open + (lastday_high - lastday_low) * 0.26
        return target_price
...
def buy_etf(code):
    ...
    try:
        ...
        ma5_price = get_movingaverage(code, 6)   # 6일 이동평균가
        ma10_price = get_movingaverage(code, 10) # 10 이동평균가
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A280940', 'A252710', 'A227550', 'A105840', 'A017550', 'A090370', 'A005850', 'A012690', 'A330590', 'A097780', 'A263770']
